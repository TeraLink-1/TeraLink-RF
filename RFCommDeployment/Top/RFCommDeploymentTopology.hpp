// ======================================================================
// \title  RFCommDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef RFCOMMDEPLOYMENT_RFCOMMDEPLOYMENTTOPOLOGY_HPP
#define RFCOMMDEPLOYMENT_RFCOMMDEPLOYMENTTOPOLOGY_HPP
// Included for access to RFCommDeployment::TopologyState and RFCommDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <RFCommDeployment/Top/RFCommDeploymentTopologyDefs.hpp>

// Remove unnecessary RFCommDeployment:: qualifications
 ...
 * RFCommDeployment::TopologyState see: RFCommDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type RFCommDeployment::TopologyState see: RFCommDeploymentTopologyDefs.hpp.
 *
