// ======================================================================
// \title  RFCommDeploymentTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <RFCommDeployment/Top/RFCommDeploymentTopologyAc.hpp>
// Note: Uncomment when using Svc:TlmPacketizer
//#include <RFCommDeployment/Top/RFCommDeploymentPacketsAc.hpp>
...
using namespace RFCommDeployment;
...
Svc::Health::PingEntry pingEntries[] = {
    {PingEntries::RFCommDeployment_blockDrv::WARN, PingEntries::RFCommDeployment_blockDrv::FATAL, "blockDrv"},
    {PingEntries::RFCommDeployment_tlmSend::WARN, PingEntries::RFCommDeployment_tlmSend::FATAL, "chanTlm"},
    {PingEntries::RFCommDeployment_cmdDisp::WARN, PingEntries::RFCommDeployment_cmdDisp::FATAL, "cmdDisp"},
    {PingEntries::RFCommDeployment_cmdSeq::WARN, PingEntries::RFCommDeployment_cmdSeq::FATAL, "cmdSeq"},
    {PingEntries::RFCommDeployment_eventLogger::WARN, PingEntries::RFCommDeployment_eventLogger::FATAL, "eventLogger"},
    {PingEntries::RFCommDeployment_fileDownlink::WARN, PingEntries::RFCommDeployment_fileDownlink::FATAL, "fileDownlink"},
    {PingEntries::RFCommDeployment_fileManager::WARN, PingEntries::RFCommDeployment_fileManager::FATAL, "fileManager"},
    {PingEntries::RFCommDeployment_fileUplink::WARN, PingEntries::RFCommDeployment_fileUplink::FATAL, "fileUplink"},
    {PingEntries::RFCommDeployment_prmDb::WARN, PingEntries::RFCommDeployment_prmDb::FATAL, "prmDb"},
    {PingEntries::RFCommDeployment_rateGroup1::WARN, PingEntries::RFCommDeployment_rateGroup1::FATAL, "rateGroup1"},
    {PingEntries::RFCommDeployment_rateGroup2::WARN, PingEntries::RFCommDeployment_rateGroup2::FATAL, "rateGroup2"},
    {PingEntries::RFCommDeployment_rateGroup3::WARN, PingEntries::RFCommDeployment_rateGroup3::FATAL, "rateGroup3"},
};
...
void configureTopology(const TopologyState& state) {
    ...
    // Note: Uncomment when using Svc:TlmPacketizer
    // tlmSend.setPacketList(RFCommDeploymentPacketsPkts, RFCommDeploymentPacketsIgnore, 1);
...
void startSimulatedCycle(Fw::TimeInterval interval) {
    ...
    // Main loop
    while (cycling) {
        RFCommDeployment::blockDrv.callIsr();
